...
## Notes for next time — end-of-level reflection
This is the last lesson in the currently planned curriculum. If a student
reaches here, they've independently used every app across both Track 4 and
Track 5 — same as Level 1's closing note, there's no separate capstone,
finishing this one already is it. This reflection happens once, here,
instead of at the end of every track:

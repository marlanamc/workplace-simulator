...
- "I feel okay writing something up even if the situation was a little
  uncomfortable." 🙂 😐 🙁
- "One thing I want to remember when something goes wrong at work: ___________"

## Notes for next time
- This is the most personal/vulnerable lesson in the set. Keep feedback warm
  and specific. The goal isn't a "correct" report — it's proof they can write
  *something* clear and in-order under a little pressure, which is most of
  what a first-time lead actually needs.

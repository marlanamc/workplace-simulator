# Lesson 1a: Read a Financial Aid Letter (Path A — Prepping for BHCC)
...
**Prerequisite:** Level 13's Path A lesson (`enrollment`)
...
- "If I didn't understand something on a real financial aid letter, I would:
  ___________"

## Notes for next time
- This is deliberately the same shape as Level 2's Lesson 3 (`paystub`) — a
  ...
  skill didn't transfer yet, and it's worth another round of Level 2's

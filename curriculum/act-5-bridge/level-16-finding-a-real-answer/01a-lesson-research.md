# Lesson 1a: Tell a Credible Source From an Unreliable One (Path A — Prepping for BHCC)
...
**Prerequisite:** Level 15's Path A lesson (`coursework`)
...
4. Pick the one you'd cite, and be ready to say why.

## Confidence check-in
- "I could tell a credible source from an unreliable one when it actually
  mattered." 🙂 😐 🙁
- "One thing I now check before trusting something I read online:
  ___________"

## Notes for next time — end-of-act reflection
This is the last Path A lesson, and closes out Act V:

- "Out of everything in this path (college portal, financial aid,
  coursework, research), the thing I feel most ready for is: ___________"
- "One thing I'd tell a friend starting this whole program: ___________"

## Notes for the teacher
- This path was originally written before Levels were introduced, when it
  was planned to follow immediately after the first promotion. It's now
  an optional elective at Levels 13-16 instead, since most students in
  this program won't go on to higher education — a student can choose
  Path B (Front Office / Healthcare Admin) instead, or skip Act V
  entirely and move straight to Act VI (Office Administrator).

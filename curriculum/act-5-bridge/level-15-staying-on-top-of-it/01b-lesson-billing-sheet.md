# Lesson 1b: Check a Billing Sheet (Path B — Front Office / Healthcare Admin)
...
## We will learn...
- match visit codes to charges on a small billing spreadsheet, and flag
...
4. Flag it in a short message to the office manager, naming the row and
   what the charge should actually be.

## Confidence check-in
- "I could catch a billing mismatch instead of assuming it's already
  correct." 🙂 😐 🙁
- "Double-checking numbers like this feels: ___________"

## Notes for next time
- This is the same underlying habit as `spreadsheet` and `formula-check` —
  a student who's comfortable with those should recognize the shape
  immediately, just applied to money instead of hours or totals.

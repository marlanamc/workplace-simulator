...
- basic video-call etiquette (mute, camera, chat) — not the technology
  itself, since a mock meeting UI is enough to teach the norms.

## Before class (teacher prep) — once built
- [ ] Simulator: a static mock team-meeting screen — join, mute/unmute,
      camera on/off, a chat panel — with one scenario prompt (e.g. "you
...
4. Use the chat to ask a question instead of interrupting out loud.
5. Read the etiquette tips that show up (e.g. "stay muted when you're not
   talking," "camera is optional, but let people know if it's off and why").

## Confidence check-in
- "I know what's expected of me in a video meeting at work." 🙂 😐 🙁
- "The thing that would make me most nervous about a real video meeting is:
  ___________"

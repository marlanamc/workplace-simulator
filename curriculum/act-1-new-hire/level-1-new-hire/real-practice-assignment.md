...
- [ ] Google Classroom (optional): post one short assignment — "Level 1
      Wrap-Up" — with a short practice email written *as if* from a
      supervisor, and a file for the student to attach.

## Student instructions (post as-is, or adapt — optional)
You just finished Level 1 in the simulator — nice work. If you'd like extra
practice, try the same thing for real:
1. Reply to the practice email using your real email, the same way you
   practiced — read it, reply (not forward), and attach the right file.

**Optional extra challenge** (for students who finish quickly or have prior
office experience): also cc a second person and confirm a specific time in
your reply.

## Teacher review
Skim for completion, not perfection — the simulator already did the graded
practice. One specific note back ("this part landed well," "try this next
time") is plenty.

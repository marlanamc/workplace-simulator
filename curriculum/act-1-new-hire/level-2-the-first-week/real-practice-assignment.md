...
- [ ] Google Classroom (optional): post **one** assignment — "Level 2
      Wrap-Up" — with a view-only mock schedule with one conflict attached.
...
- Some students will finish all three in one sitting; others may need it
  split across two days, or skip it entirely — any of those is fine.
- A student is ready for Level 3 as soon as every Level 2 task shows

...
export const TASK_ICONS: Record<TaskKey, LucideIcon> = {
  ...
  "job-posting": Newspaper,
  "job-application": PenLine,
  "resume-build": FileText,
  "interview-practice": Users,
  "job-offer": Mail,
  "w4-form": FileText,
  "i9-section1": FileText,
  "direct-deposit": Banknote,
...
export const TRACK_ICONS: Record<string, LucideIcon> = {
  ...
  research: Library,
  "confidentiality-call": Phone,
  "getting-hired-apply": Newspaper,
  "getting-hired-resume": FileText,
  "getting-hired-interview": Users,
  "getting-hired-offer": Mail,
  "getting-hired-paperwork": ClipboardList,
  "office-drive": HardDrive,

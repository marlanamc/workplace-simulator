...
export const COURSEWORK_COPY: Record<Lang, {
  ...
  es: {
    ...
    syllabus: "Lee el correo de la clienta abajo. Escribe una respuesta corta, de 2 o 3 oraciones, como lo harías en el trabajo. Entrega: viernes, 11:59 PM. No se acepta tarde.",
    dueLabel: "Entrega",

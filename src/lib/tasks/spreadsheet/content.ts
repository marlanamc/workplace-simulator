...
export const SPREADSHEET_COPY: Record<Lang, {
  ...
  en: {
    ...
    emailTotal: "Email the total to Maria",
    to: "To",
  ...
  es: {
    ...
    scenario: "Maria te pidió ingresar las propinas de esta semana en la hoja compartida, y luego enviarle el total por correo para incluirlo en la nómina.",
    appName: "Sheets",
    ...
    emailTotal: "Enviar el total a Maria por correo",
    to: "Para",
    subjectLabel: "Asunto",
...
export const RIGHT_NOW_STEPS: Localized[] = [
  ...
  {
    en: "Email Maria the total.",
    es: "Envíale el total a Maria por correo.",
  },
];

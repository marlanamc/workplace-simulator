...
export const SCHEDULE_COPY: Record<Lang, {
  ...
  en: {
    ...
    doneBody: "Thursday's shift landed on your doctor's appointment, so you asked Maria for a swap as soon as you noticed. Checking this yourself, the day the schedule goes up, keeps a scheduling conflict from turning into a missed shift or a missed appointment.",
  ...
  en: [
    {
      ...
      tip: "Do this as soon as a new schedule is posted. The sooner you notice a conflict, the easier it is to fix.",
    },
  ],
  es: [
    {

...
export const TIMECLOCK_COPY: Record<Lang, {
  ...
  en: {
    ...
    doneTitle: "You noticed a late clock-in and said something.",
    doneBody: "You got here at 7:00 AM, but the clock said 8:15 AM, so you told Maria. That is what to do before payday.",
  ...
  en: [
    {
      ...
      tip: "Do this every shift. It only takes a second, and it helps you notice a mistake early.",
    },
    {
      ...
      tip: "Noticing this before payday is much easier to fix than after.",
    },
  ],
  es: [
    {
